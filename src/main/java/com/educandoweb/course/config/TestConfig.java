...
public class TestConfig implements CommandLineRunner { // Ver interface CommandLineRunner
	...
	public void run(String... args) throws Exception {
		...
		// Associa p1 categoria {The Lord of etc..} a cat2 {Books}
		...
		// Salvando os produtos com as associações em repository
		productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
		...
		//oi1 é um item de depido q é do pedido 1 product 1 quantidade 2
		//O preço é a reprodução do p1
		//Essa relação está no UML
		...
		//Salvando no Banco no repository
